...
public class ButtonsSettings extends SettingsPreferenceFragment implements
    ...
    private void reload() {
        ...
        final boolean hasHome = navigationBarEnabled || (mDeviceHardwareKeys & KEY_MASK_HOME) != 0;
        final boolean hasAppSwitch = navigationBarEnabled || (mDeviceHardwareKeys & KEY_MASK_APP_SWITCH) != 0;
        final boolean hasBack = navigationBarEnabled || (mDeviceHardwareKeys & KEY_MASK_BACK) != 0;
